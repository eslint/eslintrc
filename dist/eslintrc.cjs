...
const debug$3 = debugOrig("eslintrc:ignore-pattern");
...
const debug$2 = debugOrig("eslintrc:config-array-factory");
...
const debug$1 = debugOrig("eslintrc:cascading-config-array-factory");
...
const debug = debugOrig("eslintrc:flat-compat");
