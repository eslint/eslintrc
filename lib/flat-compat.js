 ...
 *      plugins from.
 * @param {Map<string,Object>} options.pluginEnvironments A map of plugin environment
 *      names to objects.
 * @param {Map<string,Object>} options.pluginProcessors A map of plugin processor
 *      names to objects.
            ...
            if (plugin.processors) {
                for (const processorName of Object.keys(plugin.processors)) {
                    if (processorName.startsWith(".")) {
                        ...
                        configs.unshift({
                            files: [`**/*${processorName}`],
                            processor: pluginProcessors.get(processorName)
                        });
                    }
